export default class GameHandler {
    ...
    showFinishScreen() {
        ...
        gsap.fromTo(this.finishScreen, {opacity: 0}, {opacity: 1, duration: 0.5, pointerEvents: 'all'})
        gsap.fromTo(this.distanceText, {opacity: 0, scale: 0}, {opacity: 1, scale: 1, duration: 0.5, delay: 1})
        gsap.fromTo(this.coinText, {opacity: 0, scale: 0}, {opacity: 1, scale: 1, duration: 0.5, delay: 1.1})
        gsap.fromTo(this.replayBtn, {opacity: 0, scale: 0}, {opacity: 1, scale: 1, rotation: 720,duration: 0.5, delay: 1.3})
    }
    hideFinishScreen() {
        gsap.fromTo(this.finishScreen, {opacity:1}, {opacity:0, pointerEvents:'none', duration: 0.1})
        this.status = 'PLAYING';
        this.app.reset();
    }
}